  ...
  return (
    <section className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link href="/auth/cadastro" className="btn btn-secondary btn-sm sm:btn-md">
          Criar conta
        </Link>
        <Link href="/auth/login" className="btn btn-accent btn-sm sm:btn-md">
          Fazer login
        </Link>
        <Link href="/perfil" className="btn btn-outline btn-sm sm:btn-md">
          Ver perfil
        </Link>
        <a
      ...
      <p className="text-xs text-base-content/60">
        Configure <code>NEXT_PUBLIC_API_BASE_URL</code> se sua API JWT estiver em URL diferente de <code>http://localhost:8000/api</code>.
      </p>
      <p className="text-xs text-base-content/60">
